...
APP_INTRO = {
    "en": (
        "👋 <b>AcceptedAI</b>\n\n"
        "Here's what I do:\n"
        "📊 Compare your CV against a job you're interested in — your first 2 checks "
        "are free\n"
        "✅ Run an ATS score and give you specific fixes for your CV\n"
        "🗺 Put together a step-by-step plan to help you land the job\n"
        "🔍 Help you find vacancies that match your profile\n\n"
        "Tap below to open it now 👇"
    ),
    "uz": (
        "👋 <b>AcceptedAI</b>\n\n"
        "Mana nimalarni qila olaman:\n"
        "📊 CV'ingizni qiziqtirgan vakansiya bilan bepul solishtiraman — birinchi 2 ta "
        "tekshiruv bepul\n"
        "✅ ATS skoringini o'tkazaman va CV'ingizni yaxshilash bo'yicha maslahatlar "
        "beraman\n"
        "🗺 Ishga joylashishingiz uchun bosqichma-bosqich reja tuzaman\n"
        "🔍 Aynan sizga mos vakansiyalarni topishga yordam beraman\n\n"
        "Hoziroq ochish uchun pastdagi tugmani bosing 👇"
    ),
    "ru": (
        "👋 <b>AcceptedAI</b>\n\n"
        "Вот что я умею:\n"
        "📊 Бесплатно сравню ваше резюме с интересующей вас вакансией — первые 2 "
        "проверки бесплатно\n"
        "✅ Проведу ATS-скоринг и дам конкретные советы по улучшению резюме\n"
        "🗺 Составлю пошаговый план, чтобы устроиться на работу\n"
        "🔍 Помогу найти вакансии, которые подходят именно вам\n\n"
